...
export class ZybilContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** stamp_ens(secret_redemption_hash: field, addr: struct, timestamp: field, canceller: struct, msg_key: field, secret_consumption_hash: field) */
    stamp_ens: ((secret_redemption_hash: FieldLike, addr: EthAddressLike, timestamp: FieldLike, canceller: EthAddressLike, msg_key: FieldLike, secret_consumption_hash: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
  };
}
